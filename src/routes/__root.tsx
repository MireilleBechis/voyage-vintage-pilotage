  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4 text-center">
      <div className="max-w-md">
        <h1 className="font-serif text-2xl text-primary">Un souci est survenu</h1>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "La Dolce Vintage – Pilotage" },
      { name: "description", content: "Pilotage privé du stock de mobilier, luminaires, objets design et hi-fi vintage." },
      { property: "og:title", content: "La Dolce Vintage – Pilotage" },
      { property: "og:description", content: "Pilotage privé du stock vintage." },
